  ...
  />
      ...
      <div className="flex flex-col flex-1 w-full">
        <header className="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          <div className="relative w-full max-w-xl mr-6 focus-within:text-purple-500"> {/* Reduced max width */}
            <div className="absolute inset-y-0 flex items-center pl-2"> {/* Reduced padding-left */}
              <svg
                className="w-4 h-4"
                aria-hidden="true"
                fill="currentColor"
            ...
            <input
              className="w-full pl-8 pr-3 text-sm h-10 text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input"
              type="text"
