      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 w-full">
          ...
          <header className="z-10 py-4 bg-white shadow-sm dark:bg-gray-800">
            ...
            <svg
            className="w-6 h-6" // Adjust the size and color with Tailwind
            fill="currentColor"
          ...
          >
            <path
              fillRule="evenodd"
              d="M12 3C12.553 3 13 3.447 13 4V5C13 5.553 12.553 6 12 6C11.447 6 11 5.553 11 5V4C11 3.447 11.447 3 12 3ZM12 18C12.553 18 13 18.447 13 19V20C13 20.553 12.553 21 12 21C11.447 21 11 20.553 11 20V19C11 18.447 11.447 18 12 18ZM4.707 5.707C5.098 5.316 5.674 5.316 6.065 5.707L7.707 7.349C8.098 7.74 8.098 8.316 7.707 8.707C7.316 9.098 6.74 9.098 6.349 8.707L4.707 7.065C4.316 6.674 4.316 6.098 4.707 5.707ZM18.364 18.364C18.755 18.755 19.331 18.755 19.722 18.364C20.113 17.973 20.113 17.397 19.722 17.006L18.08 15.364C17.689 14.973 17.113 14.973 16.722 15.364C16.331 15.755 16.331 16.331 16.722 16.722L18.364 18.364ZM4.707 18.707C5.098 19.098 5.674 19.098 6.065 18.707L7.707 17.065C8.098 16.674 8.098 16.098 7.707 15.707C7.316 15.316 6.74 15.316 6.349 15.707L4.707 17.349C4.316 17.74 4.316 18.316 4.707 18.707ZM19.722 5.707C20.113 5.316 20.113 4.74 19.722 4.349C19.331 3.958 18.755 3.958 18.364 4.349L16.722 5.991C16.331 6.382 16.331 6.958 16.722 7.349C17.113 7.74 17.689 7.74 18.08 7.349L19.722 5.707ZM12 8C9.791 8 8 9.791 8 12C8 14.209 9.791 16 12 16C14.209 16 16 14.209 16 12C16 9.791 14.209 8 12 8Z"
              clipRule="evenodd"
            />
          </svg>
                  )}
